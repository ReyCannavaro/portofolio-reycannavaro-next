        ...
        <div style={{ display: "inline-flex", flexDirection: "column", minWidth: 0 }}>
          ...
          <div style={{ display: "flex", gap: 0 }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 3, marginRight: 4, paddingTop: 0 }}>
              {DAYS.map((d, i) => (
                <div key={i} style={{ height: 10, fontSize: 9, color: "var(--muted)", lineHeight: "10px", whiteSpace: "nowrap", width: 20, textAlign: "right" }}>
                  {d}
                </div>
              ))}
            </div>
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          cursor: day.inYear ? "default" : "default",
    ...
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        {languages.map((l, i) => {
          ...
          const isHovered = hovered === l.name;
          return (
            <div
              key={l.name}
              style={{
            ...
            >
              ...
              <span style={{ fontSize: 12, color: isHovered ? "var(--on-dark)" : "var(--body)", fontWeight: isHovered ? 700 : 300, flex: 1, transition: "color 0.15s" }}>
                {l.name}
              </span>
              ...
              <span style={{
                ...
                color: isHovered ? color : "var(--muted)",
      ...
      <div className="container">
        <div style={{ marginBottom: "var(--space-xxl)" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
            <h2
              ...
              style={{ opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(20px)", transition: "all 0.6s ease 0.1s" }}
            >
              GITHUB<br />STATS
            </h2>
            <a
        ...
        <div
          style={{
            ...
            background: "var(--hairline)", marginBottom: "var(--space-xxl)",
        ...
        <div
          style={{
            display: "grid", gridTemplateColumns: "1fr 300px", gap: 1,
          ...
          <div style={{ background: "var(--surface-card)", padding: "var(--space-xl)", minWidth: 0 }}>
              ...
              {!loading && (
                <div style={{ display: "flex", gap: 0, border: "1px solid var(--hairline)" }}>
                  {availableYears.map((y, idx) => (
                    <button
                      key={y}
                      onClick={() => { if (y !== selectedYear) fetchData(y); }}
                      disabled={yearLoading}
                      style={{
                        padding: "4px 12px",
                        background: selectedYear === y ? "var(--on-dark)" : "transparent",
                        color: selectedYear === y ? "var(--canvas)" : "var(--muted)",
                        border: "none",
                        borderRight: idx !== availableYears.length - 1 ? "1px solid var(--hairline)" : "none",
                        fontSize: 11, fontWeight: 700, letterSpacing: "0.5px",
                        cursor: yearLoading ? "wait" : "pointer",
                        transition: "all 0.2s",
                        opacity: yearLoading && y !== selectedYear ? 0.4 : 1,
                      }}
                    >
                      {y}
                    </button>
            ...
            <div style={{ position: "relative" }}>
              {loading ? (
                ...
                <div style={{ opacity: yearLoading ? 0.4 : 1, transition: "opacity 0.2s" }}>
                  <ContributionGraph days={data?.contributions || []} year={selectedYear} />
                </div>
              )}
              {yearLoading && (
                <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "var(--muted)" }}>Loading…</span>
                </div>
              )}
            </div>
            ...
            {data && !loading && (
              <div style={{ display: "flex", gap: "var(--space-xl)", marginTop: "var(--space-xl)", paddingTop: "var(--space-lg)", borderTop: "1px solid var(--hairline)", flexWrap: "wrap", alignItems: "center" }}>
                ...
                {!data.hasToken && (
                  <div style={{ marginLeft: "auto", padding: "6px 12px", border: "1px solid var(--hairline)", display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <div style={{
          marginTop: 1, padding: "var(--space-xl)",
          background: "var(--surface-card)", borderTop: "none",
